    ...
    if (!errorInfo) {
      return (
        <Alert
          ...
          description="The application encountered an error, but detailed information could not be obtained."
          type="error"
          showIcon
          action={
        ...
        width: '100%'
         ...
         <div className="flex flex-col gap-2 items-center left-2/4 top-2/4 absolute justify-center w-screen h-screen opacity-0 notFound  transition-opacity duration-300" style={{
            ...
            {/* <Button
                ...
                className='w-[140px] cursor-pointer pointer-events-auto !text-[#fff] !border-[#ff4e4f] !bg-[#ff4e4f] hover:!border-[#ff4e4f] hover:!text-[#fff] focus:!outline-none focus:!border-[#ff4e4f] hover:!text-[] hover:opacity-85'
                onClick={this.handleFix}
              >
                FIX
              </Button> */}
              <Button
                className='w-[140px]cursor-pointer pointer-events-auto !text-[#fff] !border-[#02160F] !bg-[#02160F] hover:!border-[#02160F] hover:!text-[#fff] focus:!outline-none focus:!border-[#02160F] hover:!text-[#000] hover:opacity-85'
